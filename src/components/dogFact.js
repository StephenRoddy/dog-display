...
<div>
      <div class="opacity-5 shadow-lg">
        <div class="card-body">
          <h4 classs="card-title">Dog Facts</h4>
          <h6 class="card-subtitle mb-2 text-muted">Overview</h6>
          <img class="img-fluid rounded mx-auto d-block" src= {props.dogImg} />
          <div>
            <p class="card-text mx-auto mt-3"><b>Type/Breed: </b>{props.breed}.</p>
            <p class="card-text mx-auto mt-3"><b>Dimensions: </b>{props.height} cm in height, and {props.weight} kg in weight.</p>
            <p class="card-text mx-auto mt-3"><b>Temperament: </b>{props.temper}.</p>
            <p class="card-text mx-auto mt-3"><b>Bred for: </b>{props.job}.</p>
